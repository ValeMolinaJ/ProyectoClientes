...
namespace ConsoleAppClientes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DataSet dat = precio.listadoPrecios();

            Console.WriteLine("id " + dat.Tables[0].Rows[0].ItemArray[0]);
            Console.WriteLine("nombre " + dat.Tables[0].Rows[0].ItemArray[1]);
            Console.WriteLine("precio " + dat.Tables[0].Rows[0].ItemArray[2]);
            Console.ReadKey();
